...
$error="Parola curenta nu este valida.";	
}
}
?>
...
<head>
	...
	<title>Schimbarea parolei de Administrator</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Parola curenta</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Confirma parola noua</label>
												<div class="col-sm-8">
