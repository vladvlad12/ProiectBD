...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Cauta <small>Donator</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Acasa</a>
            </li>
            <li class="breadcrumb-item active">Cauta donator</li>
        </ol>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Locatie </div>
...
$sql = "SELECT * from donatori where (status=:status and BloodGroup=:bloodgroup) ||  (Address=:location)";
$query = $dbh -> prepare($sql);
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text"><b>Numar telefon / Email  :</b> <?php echo htmlentities($result->MobileNumber);?> /
...
<p class="card-text"><b> Varsta:</b> <?php echo htmlentities($result->Age);?></p>
<p class="card-text"><b>Grupa de sange :</b> <?php echo htmlentities($result->BloodGroup);?></p>
<p class="card-text"><b>Adresa :</b>                  
...
?></p>
     <p class="card-text"><b>Mesaj :</b> <?php echo htmlentities($result->Message);?></p>
...
{
echo htmlentities("Nu a fost gasit nici un rezultat");
