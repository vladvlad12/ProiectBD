...
$sql="INSERT INTO  contact_donatori(name,EmailId,ContactNumber,Message) VALUES(:name,:email,:contactno,:message)";
    ...
    <div class="container">
        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <form name="sentMessage"  method="post">
                    ...
                    <button type="submit" name="send"  class="btn btn-primary">Trimite mesaj</button>
                </form>
            </div>
            ...
            <!-- Contact Details Column -->
                    <?php 
$pagetype=$_GET['type'];
$sql = "SELECT Address,EmailId,ContactNo from contact_info";
$query = $dbh -> prepare($sql);
